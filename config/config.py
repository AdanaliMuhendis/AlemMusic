...
GIT_TOKEN = getenv(
    "GIT_TOKEN", "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"
    "",
)
...
if PING_IMG_URL:
    if PING_IMG_URL != "https://te.legra.ph/Alem-Music-05-27":
...
if PLAYLIST_IMG_URL:
    if PLAYLIST_IMG_URL != "https://te.legra.ph/Alem-Music-05-27":
...
if GLOBAL_IMG_URL:
    if GLOBAL_IMG_URL != "https://te.legra.ph/Alem-Music-05-27":
...
if STATS_IMG_URL:
    if STATS_IMG_URL != "https://te.legra.ph/Alem-Music-05-27":
...
if TELEGRAM_AUDIO_URL:
    if TELEGRAM_AUDIO_URL != "https://te.legra.ph/Alem-Music-05-27":
...
if STREAM_IMG_URL:
    if STREAM_IMG_URL != "https://te.legra.ph/Alem-Music-05-27":
...
if SOUNCLOUD_IMG_URL:
    if SOUNCLOUD_IMG_URL != "https://te.legra.ph/Alem-Music-05-27":
...
if YOUTUBE_IMG_URL:
    if YOUTUBE_IMG_URL != "https://te.legra.ph/Alem-Music-05-27":
...
if TELEGRAM_VIDEO_URL:
    if TELEGRAM_VIDEO_URL != "https://te.legra.ph/Alem-Music-05-27":
